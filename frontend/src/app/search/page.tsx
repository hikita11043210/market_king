    ...
    const handleSearch = async () => {
        ...
        try {
            const params = new URLSearchParams({
                platform: platform,
                p,
                ...(min && priceType === 'current' && { min }),
                ...(max && priceType === 'current' && { max }),
                ...(max && priceType === 'buyNow' && { aucmax_bidorbuy_price: max }),
            ...
            const response = await fetch(`/api/search/yahoo-auction/items/?${params}`, {
                method: 'GET',
            });
